export const translations = {
  fr: {
    ...
    supportNav: "Support",
    dhlInvoicePayment: "Paiement de votre facture DHL",
    completePayment: "Complétez votre paiement en toute sécurité",
    ...
    copyright: "© 2024 DHL International GmbH. Tous droits réservés.",
  ...
  en: {
    ...
    supportNav: "Support",
    dhlInvoicePayment: "DHL Invoice Payment",
    ...
    copyright: "© 2024 DHL International GmbH. All rights reserved.",
  ...
  es: {
    ...
    supportNav: "Soporte",
    dhlInvoicePayment: "Pago de factura DHL",
    completePayment: "Complete su pago de forma segura",
    sslSecure: "Conexión segura SSL",
    ...
    copyright: "© 2024 DHL International GmbH. Todos los derechos reservados.",
  ...
  it: {
    ...
    supportNav: "Supporto",
    dhlInvoicePayment: "Pagamento fattura DHL",
    completePayment: "Completa il pagamento in sicurezza",
    sslSecure: "Connessione sicura SSL",
    ...
    copyright: "© 2024 DHL International GmbH. Tutti i diritti riservati.",
  ...
  de: {
    ...
    supportNav: "Support",
    dhlInvoicePayment: "DHL Rechnungszahlung",
    completePayment: "Schließen Sie Ihre Zahlung sicher ab",
    ...
    copyright: "© 2024 DHL International GmbH. Alle Rechte vorbehalten.",
